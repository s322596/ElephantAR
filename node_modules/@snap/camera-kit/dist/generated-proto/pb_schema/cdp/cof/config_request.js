...
export const ConfigTargetingRequest = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.propertyOverrides !== undefined) {
            PropertyOverrides.encode(message.propertyOverrides, writer.uint32(322).fork()).ldelim();
        }
        if (message.forLockscreenMode === true) {
    ...
    fromPartial(object) {
        ...
        message.propertyOverrides =
            object.propertyOverrides !== undefined && object.propertyOverrides !== null
